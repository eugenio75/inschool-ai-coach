                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-3 flex-wrap pr-8">
                          ...
                          <p className="text-[18px] font-semibold tracking-tight text-foreground">{c.nome}</p>
                          {c.is_sample && (
                            <span className="rounded-full bg-amber-50 dark:bg-amber-500/15 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-amber-700 dark:text-amber-300">
                              ✨ Esempio
                            </span>
                          )}
                          {hasAlert && (
                            <span className="bg-destructive text-destructive-foreground text-[11px] font-semibold px-2 py-0.5 rounded-full">
                              {alertCount}
                            </span>
                          )}
                        </div>
